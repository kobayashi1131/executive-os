---
name: "source-command-executive-review"
description: "Migrated source command `executive-review`"
---

# source-command-executive-review

Use this skill when the user asks to run the migrated source command `executive-review`.
